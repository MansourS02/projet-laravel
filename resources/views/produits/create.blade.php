        ...
        <form action="{{ route('produits.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="category-icons">
                    <div>
                        <input type="radio" class="category-option" id="cat-electro" name="categorie" value="Électronique" required>
                    ...
                    <div>
                        <input type="radio" class="category-option" id="cat-vetements" name="categorie" value="Vêtements">
                    ...
                    <div>
                        <input type="radio" class="category-option" id="cat-accessoires" name="categorie" value="Accessoires">
                    ...
                    <div>
                        <input type="radio" class="category-option" id="cat-chaussures" name="categorie" value="Chaussures">
                    ...
                    <div>
                        <input type="radio" class="category-option" id="cat-meubles" name="categorie" value="Meubles">
                    ...
                    <div>
                        <input type="radio" class="category-option" id="cat-vaisselier" name="categorie" value="Vaisselier">
...
function previewImage(event) {
    ...
    if (file) {
        ...
        fileLabel.innerHTML = '<span style="font-size: 2rem;">✓</span><span>Image sélectionnée</span>';
